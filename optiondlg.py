...
class QuoteDlg(QDialog, quote_option.Ui_Form):
    ...
    def handle_display(self, data):
        ...
        # set greeks 
        #self.iv_1.setText(str(globaldef.spreadBid))
       # self.iv_2.setText(str(globaldef.spreadAsk))
        #self.spread2Edit.setText(str(globaldef.spreadAsk))
        #self.info_stream.append("<b>%s</b> | security1 new price:<b>%s</b> | security2 new price:<b>%s</b>|"
                             #   % (str(data[0][0])[0:6], str(data[0][4]), str(data[1][4])))
    ...
    def greeks_display(self,data):
        ...
        for i,elem in enumerate(globaldef.secID):
            nindex=option_data[option_data['option_code']=='10001771.SH'].index[0]
